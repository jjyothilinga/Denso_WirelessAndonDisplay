...
//  Lamp Indication Association

#define STAT_1_RED_LAMP				PORTBbits.RB0
#define STAT_1_RED_LAMP_DIRECTION	TRISBbits.TRISB0
#define STAT_1_YEL_LAMP				PORTBbits.RB1
#define STAT_1_YEL_LAMP_DIRECTION	TRISBbits.TRISB1
#define STAT_2_RED_LAMP				PORTBbits.RB2
#define STAT_2_RED_LAMP_DIRECTION	TRISBbits.TRISB2
#define STAT_2_YEL_LAMP				PORTBbits.RB3
#define STAT_2_YEL_LAMP_DIRECTION	TRISBbits.TRISB3
#define STAT_3_RED_LAMP				PORTBbits.RB4
#define STAT_3_RED_LAMP_DIRECTION	TRISBbits.TRISB4
#define STAT_3_YEL_LAMP				PORTBbits.RB5
#define STAT_3_YEL_LAMP_DIRECTION	TRISBbits.TRISB5
#define STAT_4_RED_LAMP				PORTBbits.RB6
#define STAT_4_RED_LAMP_DIRECTION	TRISBbits.TRISB6
#define STAT_4_YEL_LAMP				PORTBbits.RB7
#define STAT_4_YEL_LAMP_DIRECTION	TRISBbits.TRISB7

#define STAT_5_RED_LAMP				PORTDbits.RD0
#define STAT_5_RED_LAMP_DIRECTION	TRISDbits.TRISD0
#define STAT_5_YEL_LAMP				PORTDbits.RD1
#define STAT_5_YEL_LAMP_DIRECTION	TRISDbits.TRISD1
#define STAT_6_RED_LAMP				PORTDbits.RD2
#define STAT_6_RED_LAMP_DIRECTION	TRISDbits.TRISD2
#define STAT_6_YEL_LAMP				PORTDbits.RD3
#define STAT_6_YEL_LAMP_DIRECTION	TRISDbits.TRISD3
#define STAT_7_RED_LAMP				PORTDbits.RD4
#define STAT_7_RED_LAMP_DIRECTION	TRISDbits.TRISD4
#define STAT_7_YEL_LAMP				PORTDbits.RD5
#define STAT_7_YEL_LAMP_DIRECTION	TRISDbits.TRISD5
#define STAT_8_RED_LAMP				PORTDbits.RD6
#define STAT_8_RED_LAMP_DIRECTION	TRISDbits.TRISD6
#define STAT_8_YEL_LAMP				PORTDbits.RD7
#define STAT_8_YEL_LAMP_DIRECTION	TRISDbits.TRISD7

#define STAT_9_RED_LAMP				PORTAbits.RA0
#define STAT_9_RED_LAMP_DIRECTION	TRISAbits.TRISA0
#define STAT_9_YEL_LAMP				PORTAbits.RA1
#define STAT_9_YEL_LAMP_DIRECTION	TRISAbits.TRISA1


//Hooter
#define HOOTER						PORTAbits.RA3
#define HOOTER_DIRECTION			TRISAbits.TRISA3
